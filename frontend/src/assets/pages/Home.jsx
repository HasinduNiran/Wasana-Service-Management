        ...
        <div class="pricing flex flex-wrap justify-center w-full mx-auto mb-12">
          <div class="pricing-item relative flex flex-col items-stretch text-center flex-shrink-0 flex-grow basis-80 m-4 bg-white rounded-2xl shadow-md hover:shadow-lg z-10">
            <div class="pricing-deco bg-red-700 rounded-t-lg p-20 relative">
              <svg
                class="pricing-deco-img absolute bottom-0 left-0 w-full h-40"
                viewBox="0 0 300 100"
                preserveAspectRatio="none"
                xmlns="http://www.w3.org/2000/svg"
              >
                <path
                  class="deco-layer deco-layer--1 transition-transform duration-500"
                  fill="#FFFFFF"
                  opacity="0.6"
              ...
              c48.654-4.056,69.94,16.218,69.94,16.218v54.396H30.913V43.944z"
                />
                <path
                  class="deco-layer deco-layer--2 transition-transform duration-500"
                  fill="#FFFFFF"
                  opacity="0.6"
              ...
              c48.653-4.055,69.939,16.218,69.939,16.218v54.396H-35.667V44.628z"
                />
                <path
                  class="deco-layer deco-layer--3 transition-transform duration-500"
                  fill="#FFFFFF"
                  opacity="0.7"
              ...
              <h3 class="pricing-title text-xs uppercase tracking-widest text-black">
                Business
              </h3>
            </div>
            ...
            <button class="pricing-action font-bold mx-12 mb-8 py-4 px-8 text-white rounded-full bg-red-700 hover:bg-red-900 transition-colors">
              Choose plan
            </button>
          </div>
